...
class StoreReportRequest extends FormRequest
{
            ...
            'content' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if (!str_contains($value, '<ol>') || !str_contains($value, '<li>')) {
                        $fail('❌ Xisobot faqat raqamli ro\'yxat (numbered list) formatida bo\'lishi kerak!');
                        return;
                    }
    ...
    public function messages()
    {
        return [
            ...
            'type.required' => '❌ Xisobot turi tanlanishi shart',
            'type.in' => '❌ Noto\'g\'ri xisobot turi',
            'start_date.required' => '❌ Boshlanish sanasi kiritilishi shart',
            'end_date.required' => '❌ Tugash sanasi kiritilishi shart',
            'end_date.after_or_equal' => '❌ Tugash sanasi boshlanish sanasidan kech yoki teng bo\'lishi kerak',
